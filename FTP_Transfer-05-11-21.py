...
DownloadType = input("Enter: \n\t1 for Dispatch folder \n\t2 for Weed Board folder\n\n")
if DownloadType == "1":
    Output_Variables = DispatchVariables # WeedBoardVariables # DispatchVariables #    WeedBoardVariables
    Output_Save_Path = Dispatch_Output_Save_Path # WeedBoard_Output_Save_Path # Dispatch_Output_Save_Path #    WeedBoard_Output_Save_Path
    print("You entered 1; A Dispatch file folder will be created.")
elif DownloadType == "2":
    ...
    print("you entered: 2; A Weed Board file folder will be created.")
else:
    exit()
...
print('\n\nFile Transfer Protocol Completed')